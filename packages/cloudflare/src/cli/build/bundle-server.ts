...
`,
  ...
  console.log(`\x1b[35mWorker saved in \`${getOutputWorkerLocation(openNextOptions)}\` 🚀\n\x1b[0m`);
}
...
/**
 * Gets the location of the worker.js file generated by the build process
 *
 * @param openNextOptions the open-next build options
 * @returns the location of the worker.js file that the build process generates
 */
export function getOutputWorkerLocation(openNextOptions: BuildOptions): string {
